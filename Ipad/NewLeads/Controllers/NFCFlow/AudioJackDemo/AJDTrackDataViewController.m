...
@property (nonatomic, assign) ACRTrackDataOption dataOptions;
@end
...
- (void)viewDidLoad
{
    ...
    self.encryptedTrack1Switch.on = (_dataOptions | ACRTrackDataOptionEncryptedTrack1);
    self.encryptedTrack2Switch.on = (_dataOptions | ACRTrackDataOptionEncryptedTrack2);
    self.maskedTrack1Switch.on = (_dataOptions | ACRTrackDataOptionMaskedTrack1);
    self.maskedTrack2Switch.on = (_dataOptions | ACRTrackDataOptionMaskedTrack2);
...
- (void) setTrackDataOptions:(ACRTrackDataOption)aDataOptions
{
    _dataOptions = aDataOptions;
}
